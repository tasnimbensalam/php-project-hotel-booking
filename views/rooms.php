								...
								<div class="room-wrap d-md-flex">
									...
									<div class="half right-arrow d-flex align-items-center">
										<div class="text p-4 p-xl-5 text-center">
											...
											<p class="pt-1"><a href="http://localhost/tesnim/hotel-booking/views/room-single.php?id=<?php echo $room['id'];?>" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
										</div>
									</div>
								</div>
							</div>
