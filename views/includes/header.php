<?php
session_start();
define("APPURL","http://localhost/tesnim/hotel-booking/views");
define("HOTELSIMAGES","http://localhost/tesnim/hotel-booking/views/admin-panel/hotels-admins/hotel_images");
define("ROOMSIMAGES","http://localhost/tesnim/hotel-booking/views/admin-panel/rooms-admins/room_images");
