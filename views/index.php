            ...
            <h2>Apartment Room</h2>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="#" class="img" style="background-image: url(<?php echo ROOMSIMAGES; ?>/<?php echo $r['image']?>);"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
    							<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
	    						<h3 class="mb-3"><a href="<?php echo APPURL; ?>/rooms-single.php"><?php echo $r['name']?></a></h3>
	    						<ul class="list-accomodation">
	    							<li><span>Max:</span> <?php echo $r['num_persons']?> Persons</li>
	    							<li><span>Size:</span> <?php echo $r['size']?> m2</li>
	    							<li><span>View:</span> <?php echo $r['view']?></li>
	    							<li><span>Bed:</span> <?php echo $r['num_beds']?></li>
	    						</ul>
	    						<p class="pt-1"><a href="<?php echo APPURL; ?>/room-single.php?id=<?php echo $r['id']?>" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			</div>
